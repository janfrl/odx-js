...
<template>
  <header class="h-12 border-b border-base flex items-center px-4 bg-zinc-50/50 dark:bg-zinc-900/20 justify-between shrink-0">
    ...
    <!-- Context Indicator: Only show service name when in Services Tab -->
