...
```
Browser ──► @bc8-odx/nuxt ──► @bc8-odx/proxy ──► SAP Backend
                │                    │
                │             @bc8-odx/core (shared types & client)
                │
          @bc8-odx/explorer (DevTools UI)
```

| Package | Role | When to Use |
| --- | --- | --- |
| [`@bc8-odx/nuxt`](/nuxt/getting-started) | Nuxt 4 module with auto-imports, DevTools, and zero-config setup | You are building a Nuxt 4 application |
| [`@bc8-odx/proxy`](/proxy/installation) | Standalone Nitro/H3 proxy for BTP auth, CSRF, and routing | You need a BFF layer or use a non-Nuxt framework |
| [`@bc8-odx/core`](/core/installation) | Framework-agnostic TypeScript SDK and OData types | You want the base client without any framework binding |
| [`@bc8-odx/explorer`](/explorer/setup) | Browser-based DevTools UI for schema visualization and traffic monitoring | You want to introspect EDMX schemas and debug live requests |
