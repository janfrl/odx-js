...
| `pnpm --filter @me-tools/odx-nuxt run test:live:northwind` | Opt-in live smoke against the public Northwind V2 and V4 services; it is intentionally outside the repository gate. |
