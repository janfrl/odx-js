...
| SAP Open UX annotation packages | Keep as compatibility and vocabulary-breadth oracles. The first compiler slice uses an owned portable projection; reconsider isolated offline reuse only when vocabulary maintenance cost justifies it. |
