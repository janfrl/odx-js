...
assertIncludes(app, 'ODataServiceRegistry[\'Sales-Order\']', 'minimal app')
assertIncludes(app, 'useOData(\'Sales-Order\')', 'minimal app')
assertIncludes(app, 'salesOrderService.Products', 'minimal app')
