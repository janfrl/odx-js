...
<template>
  <UApp>
    <div class="h-screen flex overflow-hidden font-sans">
      <!-- Sidebar -->
      <aside class="w-16 border-r border-gray-200 dark:border-gray-800 flex flex-col items-center py-4 gap-4 bg-gray-50/50 dark:bg-gray-900/50 shrink-0">
        <UTooltip
          v-for="item in items"
          :key="item.id"
          :text="item.label"
      ...
      <!-- Main Container -->
      <div class="flex-1 flex flex-col min-w-0 overflow-hidden relative bg-white dark:bg-black">
        <!-- Header -->
        <header class="h-14 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-6 shrink-0">
