            ...
            <tbody class="divide-y divide-neutral-100 dark:divide-neutral-900 font-mono text-neutral-700 dark:text-neutral-300">
              ...
              >
                ...
                >
                  ...
                  <td class="px-8 py-5 text-[14px] font-bold tracking-tight text-neutral-900 dark:text-neutral-100">
                  ...
                  <td class="px-8 py-5 text-right text-neutral-500 tabular-nums">
                    <span class="font-bold text-sm">{{ log.duration }}</span>
